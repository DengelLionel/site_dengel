...
const SobreMi = () => {
  return (
    ...
    <div className='hidden md:flex md:flex-row md:justify-center md:items-center md:gap-[30px] md:h-full'>
        ...
        <section className='bg-white5 pt-[38px] pl-[28px] pr-[28px] pb-[28px] w-[347px] h-auto rounded-br-[21px] rounded-bl-[21px] rounded-tr-[21px] rounded-tl-[21px] shadow-shadow2'>
            ...
            <IconLinkedin/>
            <IconGithub/>
             <IconInstagram fill={"#201F47"}/>
                
            </article>
        </section>
       
            <button className='bg-yellow2 w-[303px] rounded-br-[24px] rounded-bl-[24px] rounded-tr-[24px] rounded-tl-[24px] pt-[12px] pb-[13px] text-center font-roboto font-semibold text-[20px] tracking-[0.015em] leading-[23px]'>Mira mi brochure</button>
        ...
        <section className='flex flex-col gap-[15px] items-center justify-center'>
            ...
            <p className='w-[263px] font-roboto font-semibold text-[20px] leading-[23px] tracking-[0.015em] text-textPrimary2 text-center'>“Un buen desarrollador de software trabaja con disciplina y constancia desde el primer día”</p>
