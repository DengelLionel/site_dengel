...
const Card = ({image,titulo}:cards) => {
  return (
    ...
    <section className={styles.card}>
      ...
      <Image  width={133} height={175}  src={image}   layout="intrinsic"
      alt={titulo}/>
      </div>
    ...
    <section className={styles.card1024}>
      ...
      <Image className=" rounded-tr-[20px] rounded-tl-[20px]"  src={image} priority={true} layout="intrinsic" width={300} height={200} alt={titulo}/>
